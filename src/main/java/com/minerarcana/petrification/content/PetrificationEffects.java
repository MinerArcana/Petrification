...
import com.minerarcana.petrification.effects.RevivifyEffect;
...
public class PetrificationEffects {
    ...
    public static final RegistryObject<Effect> REVIVIFY = EFFECTS.register("revivify", RevivifyEffect::new);
