...
public class PetrificationEffects {
    ...
    public static final RegistryObject<Effect> REVIVIFY = EFFECTS.register("revivify", () -> new PetrificationEffect().addAttributesModifier(Attributes.ARMOR,"fbfe1f18-9752-47ad-b586-c21e52eee2d3",1,AttributeModifier.Operation.ADDITION).addAttributesModifier(Attributes.MOVEMENT_SPEED,"3b3be5a8-b2f8-4823-a8c0-6499fe4a30d5",-0.1, AttributeModifier.Operation.MULTIPLY_BASE));
