...
public class PetrificationCloudEntity extends Entity {
    ...
    public PetrificationCloudEntity(EntityType<? extends AreaEffectCloudEntity> cloud, World world) {
        super(cloud, world);
        this.noClip = true;
        this.setRadius(3.0F);
    }

    public PetrificationCloudEntity(World worldIn, double x, double y, double z) {
                                ...
                                if (d2 <= (double)(f * f)) {
                                    ...
                                    for(EffectInstance effectinstance : list) {
                                        if (livingentity.isPotionActive(PETRIFICATION.get())) {
                                            ...
                                            livingentity.addPotionEffect(new EffectInstance(effectinstance.getPotion(),600,currentAmp + effectinstance.getAmplifier()));
                                        }else {
